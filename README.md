...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-08 10:00`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/18b234c0-a578-4439-9bd4-b8107323bea6.git
$ cd 18b234c0-a578-4439-9bd4-b8107323bea6
```
